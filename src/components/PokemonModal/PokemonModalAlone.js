...
import { notSelectedPokemons, pokemonSelection, selectedPokemons } from '../../redux/actions/pokemonActions'
import style from './PokemonModal.module.css'

const PokemonModalAlone = ({ showPokemonInfo, pokemonSelection, notSelectedPokemons, selectedPokemons }) => {
