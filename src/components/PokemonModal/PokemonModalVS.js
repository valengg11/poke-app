...
const PokemonModalVS = ({ showPokemonInfo, pokemonSelection, notSelectedPokemons, selectedPokemons }) => {
    ...
    if (String(pokemonSelection[0].name).toUpperCase() === String(pokemonSelection[1].name).toUpperCase()) {
        comparativeMessage = `${String(pokemonSelection[0].name).toUpperCase()} VS. ${String(pokemonSelection[1].name).toUpperCase()}2`
    } else {
        comparativeMessage = `${String(pokemonSelection[0].name).toUpperCase()} VS. ${String(pokemonSelection[1].name).toUpperCase()}`
    }
    return (
        <div>
            <Modal className={style.modal} show={showPokemonInfo} onHide={handleClose}>
                ...
                <Modal.Footer>
                    <Button variant="primary" onClick={selectedPokemons}>Compare to</Button>
                </Modal.Footer>
            </Modal>
        </div>
    )
